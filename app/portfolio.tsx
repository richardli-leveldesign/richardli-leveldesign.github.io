...
function ContactContent() { const { dictionary } = useLanguage(); const content = (dictionary as any).contact; const actions = (dictionary as any).actions; return <section className="contact-page"><div className="contact-content"><h1>{content.title}</h1><p>{content.description}</p><a className="contact-email" href="mailto:ruichil1030@gmail.com">ruichil1030@gmail.com</a><a className="contact-phone" href="tel:+18723778884">(872) 377-8884</a><div className="contact-meta"><a href="mailto:ruichil1030@gmail.com" aria-label={actions.email}>✉</a><a href="https://www.linkedin.com/in/ruichi-li-9903372b1/" target="_blank" rel="noreferrer" aria-label={actions.linkedin}>in</a></div></div></section>; }
