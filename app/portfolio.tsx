...
function HamsterballinPage({ project }: { project: (typeof projects)[number] }) {
  return <SiteShell activePath={`/projects/${project.slug}`}><section className="project-hero blacksite-hero"><img src={project.image} alt="Hamsterballin' project cover" /><div className="project-hero-shade" /><div className="project-hero-copy"><span className="eyebrow">01 / UNREAL ENGINE 5</span><h1>Hamsterballin&apos;</h1><p>Roll and bounce around as a cute hamster racing through imaginative tracks in this competitive arcade racer.</p></div></section><div className="blacksite-page hamsterballin-page">
    <section className="blacksite-overview"><div className="blacksite-about-media"><img className="blacksite-about-video" src={project.image} alt="Hamsterballin' in-game racing track" /></div><dl><div><dt>POSITIONS</dt><dd>Level Designer</dd></div><div><dt>ENGINE</dt><dd>Unreal Engine 5</dd></div><div><dt>PLATFORM</dt><dd>PC</dd></div><div><dt>DEVELOPMENT</dt><dd>42 developers<br />Finished May 2025<br />Launched TBD</dd></div></dl></section>
    ...
    <section className="blacksite-section blacksite-gallery-section"><span className="eyebrow">GALLERY</span></section>
  </div></SiteShell>;
}
