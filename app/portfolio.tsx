...
function KillTheMakersPage({ project }: { project: (typeof projects)[number] }) {
  return <SiteShell activePath={`/projects/${project.slug}`}><section className="project-hero blacksite-hero"><img src="/kill-the-makers-hero-wide.png" alt="Kill the Makers Header Capsule" /><div className="project-hero-shade" /><div className="project-hero-copy"><span className="eyebrow">04 / UNITY</span><h1>Kill the Makers</h1><p>A 2D puzzle-platformer about movement, combat, resource management, and mastering environmental interactions.</p></div></section><div className="blacksite-page kill-makers-page">
